...
namespace WebStore.Tests.Controllers
{
    ...
    public class HomeControllerTests
    {
        ...
        public void Throw_ApplicationException_with_Test_error()
        {
            var controller = new HomeController();
            controller.Throw();
        }
        ...
        [TestMethod]
        public void Throw_ApplicationException_with_Test_error2()
        {
        ...
        [TestMethod]
        public void Throw_ApplicationException_with_Test_error3()
        {
            const string expected_exception_message = "Test error!";
